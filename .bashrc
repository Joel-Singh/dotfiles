...
alias lg="lazygit"
alias gd="git diff"
alias cr="cargo run --features bevy/dynamic_linking"
...
alias snapshot="git add -A && git diff --staged --no-ext-diff -U0 && git commit -m \"Snapshot \" && git push"
alias ss="snapshot"
